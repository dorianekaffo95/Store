...
jardiwinery_storage_set('options_prefix', 'jardiwinery');		// Prefix for the theme options in the postmeta and wp options
...
require_once JARDIWINERY_THEME_PATH . 'plugins/plugin.contact-form-7.php';
require_once JARDIWINERY_THEME_PATH . 'plugins/plugin.trx_updater.php';
require_once JARDIWINERY_THEME_PATH . 'plugins/plugin.elegro-payment.php';
require_once JARDIWINERY_THEME_PATH . 'plugins/plugin.product-delivery-date-for-woocommerce-lite.php';
