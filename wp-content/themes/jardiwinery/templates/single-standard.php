...
if ( !function_exists( 'jardiwinery_template_single_standard_output' ) ) {
	function jardiwinery_template_single_standard_output($post_options, $post_data) {
		...
		if (!$post_data['post_protected'] && (
			...
			(jardiwinery_get_custom_option('show_featured_image')=='yes' && $post_data['post_thumb'])
		)) {
			?>
		...
		if ($post_data['post_protected']) { 
			...
			if (function_exists('jardiwinery_reviews_wrapper')){
                ...
                jardiwinery_show_layout($post_data['post_content']);
            }
		...
		if (!$sidebar_present) jardiwinery_close_wrapper();
