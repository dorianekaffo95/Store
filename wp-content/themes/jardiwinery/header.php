...
<body <?php body_class();?>>
	...
	<div class="body_wrap<?php echo !empty($class) ? ' '.esc_attr($class) : ''; ?>"<?php echo !empty($style) ? ' style="'.esc_attr($style).'"' : ''; ?>>
		...
		<div class="page_wrap">
			...
			$title_outheader = $top_panel_style != 'header_7' || ($top_panel_style == 'header_7' && jardiwinery_get_custom_option('show_page_title_inheader') !='yes');
			if ( $title_outheader && ($show_title || $show_breadcrumbs)) {
				?>
