...
if (!function_exists('jardiwinery_team_add_override_options')) {
    //Handler of add_action('trx_utils_filter_override_options', 'jardiwinery_team_add_override_options');
...
if (!function_exists('jardiwinery_team_save_data')) {
	//Handler of add_action('save_post', 'jardiwinery_team_save_data');
...
if ( !function_exists( 'jardiwinery_team_detect_inheritance_key' ) ) {
	//Handler of add_filter('jardiwinery_filter_detect_inheritance_key',	'jardiwinery_team_detect_inheritance_key', 9, 1);
...
if ( !function_exists( 'jardiwinery_team_get_blog_type' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_blog_type',	'jardiwinery_team_get_blog_type', 9, 2);
...
if ( !function_exists( 'jardiwinery_team_get_blog_title' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_blog_title',	'jardiwinery_team_get_blog_title', 9, 2);
...
if ( !function_exists( 'jardiwinery_team_get_stream_page_title' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_stream_page_title',	'jardiwinery_team_get_stream_page_title', 9, 2);
...
if ( !function_exists( 'jardiwinery_team_get_stream_page_id' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_stream_page_id',	'jardiwinery_team_get_stream_page_id', 9, 2);
...
if ( !function_exists( 'jardiwinery_team_get_stream_page_link' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_stream_page_link',	'jardiwinery_team_get_stream_page_link', 9, 2);
...
if ( !function_exists( 'jardiwinery_team_get_current_taxonomy' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_current_taxonomy',	'jardiwinery_team_get_current_taxonomy', 9, 2);
...
if ( !function_exists( 'jardiwinery_team_is_taxonomy' ) ) {
	//Handler of add_filter('jardiwinery_filter_is_taxonomy',	'jardiwinery_team_is_taxonomy', 9, 2);
...
if ( !function_exists( 'jardiwinery_team_query_add_filters' ) ) {
	//Handler of add_filter('jardiwinery_filter_query_add_filters',	'jardiwinery_team_query_add_filters', 9, 2);
...
if ( !function_exists( 'jardiwinery_sc_team' ) ) {
	...
	add_shortcode('trx_team', 'jardiwinery_sc_team');
}
...
if ( !function_exists( 'jardiwinery_sc_team_item' ) ) {
	...
	add_shortcode('trx_team_item', 'jardiwinery_sc_team_item');
}
// ---------------------------------- [/trx_team] ---------------------------------------
...
if (!function_exists('jardiwinery_team_reg_shortcodes')) {
	//Handler of add_filter('jardiwinery_action_shortcodes_list',	'jardiwinery_team_reg_shortcodes');
				...
				"trx_team" => array(
					...
					"params" => array(
						...
						"cat" => array(
							...
							"style" => "list",
							"multiple" => true,
							"options" => jardiwinery_array_merge(array(0 => esc_html__('- Select category -', 'trx_utils')), $team_groups)
						),
						"count" => array(
...
if (!function_exists('jardiwinery_team_reg_shortcodes_vc')) {
	//Handler of add_filter('jardiwinery_action_shortcodes_list_vc',	'jardiwinery_team_reg_shortcodes_vc');
		...
		vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"class" => "",
						"value" => array_flip(jardiwinery_array_merge(array(0 => esc_html__('- Select category -', 'trx_utils')), $team_groups)),
						"type" => "dropdown"
					),
					array(
						"param_name" => "columns",
