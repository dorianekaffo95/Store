...
if (!function_exists('jardiwinery_sc_googlemap')) {	
	function jardiwinery_sc_googlemap($atts, $content = null) {
        ...
        foreach ($markers as $marker) {
            ...
            if (jardiwinery_get_theme_option('api_google') != '') {
	...
	add_shortcode("trx_googlemap", "jardiwinery_sc_googlemap");
}
...
if (!function_exists('jardiwinery_sc_googlemap_marker')) {	
	...
	add_shortcode("trx_googlemap_marker", "jardiwinery_sc_googlemap_marker");
}
