...
if (!function_exists('jardiwinery_sc_section')) {	
	...
	add_shortcode('trx_section', 'jardiwinery_sc_section');
}
...
if (!function_exists('jardiwinery_sc_block')) {	
	...
	add_shortcode('trx_block', 'jardiwinery_sc_block');
}
		...
		$sc = array(
			...
			"params" => array(
                ...
                array(
                    ...
                    "heading" => esc_html__("Section style", 'trx_utils'),
                    "description" => wp_kses_data( __("Select section style", 'trx_utils') ),
                    "admin_label" => true,
                    "class" => "",
                    "value" => array(
                        esc_html__('Original', 'trx_utils') => 'section_style_original',
                        esc_html__('Contacts block', 'trx_utils') => 'section_style_contact',
                        esc_html__('Title with underline', 'trx_utils') => 'section_style_underline',
                        esc_html__('Title align to left', 'trx_utils') => 'section_style_left',
                        esc_html__('Section in inverse color', 'trx_utils') => 'section_style_inverse'
                    ),
                    "type" => "dropdown"
                ),
				array(
