...
if (!function_exists('jardiwinery_sc_call_to_action')) {	
	...
	add_shortcode('trx_call_to_action', 'jardiwinery_sc_call_to_action');
}
		...
		vc_map( array(
			...
			"params" => array(
                ...
                array(
                    ...
                    "heading" => esc_html__("Block's style color", 'trx_utils'),
                    "description" => wp_kses_data( __("Select block's style color", 'trx_utils') ),
                    "class" => "",
                    "value" => array(
