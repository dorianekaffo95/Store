...
if (!function_exists('jardiwinery_clients_after_theme_setup')) {
	...
	function jardiwinery_clients_after_theme_setup() {
		...
		if (jardiwinery_storage_get_array('post_override_options', 'page')=='clients') {
			// Meta box fields
			jardiwinery_storage_set_array('post_override_options', 'title', esc_html__('Client Options', 'trx_utils'));
...
if ( !function_exists( 'jardiwinery_clients_detect_inheritance_key' ) ) {
	//Handler of add_filter('jardiwinery_filter_detect_inheritance_key',	'jardiwinery_clients_detect_inheritance_key', 9, 1);
...
if ( !function_exists( 'jardiwinery_clients_get_blog_type' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_blog_type',	'jardiwinery_clients_get_blog_type', 9, 2);
...
if ( !function_exists( 'jardiwinery_clients_get_blog_title' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_blog_title',	'jardiwinery_clients_get_blog_title', 9, 2);
...
if ( !function_exists( 'jardiwinery_clients_get_stream_page_title' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_stream_page_title',	'jardiwinery_clients_get_stream_page_title', 9, 2);
...
if ( !function_exists( 'jardiwinery_clients_get_stream_page_id' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_stream_page_id',	'jardiwinery_clients_get_stream_page_id', 9, 2);
...
if ( !function_exists( 'jardiwinery_clients_get_stream_page_link' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_stream_page_link',	'jardiwinery_clients_get_stream_page_link', 9, 2);
...
if ( !function_exists( 'jardiwinery_clients_get_current_taxonomy' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_current_taxonomy',	'jardiwinery_clients_get_current_taxonomy', 9, 2);
...
if ( !function_exists( 'jardiwinery_clients_is_taxonomy' ) ) {
	//Handler of add_filter('jardiwinery_filter_is_taxonomy',	'jardiwinery_clients_is_taxonomy', 9, 2);
...
if ( !function_exists( 'jardiwinery_clients_query_add_filters' ) ) {
	//Handler of add_filter('jardiwinery_filter_query_add_filters',	'jardiwinery_clients_query_add_filters', 9, 2);
...
if ( !function_exists( 'jardiwinery_sc_clients' ) ) {
	...
	add_shortcode('trx_clients', 'jardiwinery_sc_clients');
}
...
if ( !function_exists( 'jardiwinery_sc_clients_item' ) ) {
	...
	add_shortcode('trx_clients_item', 'jardiwinery_sc_clients_item');
}
// ---------------------------------- [/trx_clients] ---------------------------------------
...
if (!function_exists('jardiwinery_clients_reg_shortcodes')) {
	//Handler of add_filter('jardiwinery_action_shortcodes_list',	'jardiwinery_clients_reg_shortcodes');
				...
				"trx_clients" => array(
					...
					"params" => array(
						...
						"cat" => array(
							...
							"style" => "list",
							"multiple" => true,
							"options" => jardiwinery_array_merge(array(0 => esc_html__('- Select category -', 'trx_utils')), $clients_groups)
						),
						"count" => array(
...
if (!function_exists('jardiwinery_clients_reg_shortcodes_vc')) {
	//Handler of add_filter('jardiwinery_action_shortcodes_list_vc',	'jardiwinery_clients_reg_shortcodes_vc');
		...
		vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"class" => "",
						"value" => array_flip(jardiwinery_array_merge(array(0 => esc_html__('- Select category -', 'trx_utils')), $clients_groups)),
						"type" => "dropdown"
					),
					array(
						"param_name" => "columns",
