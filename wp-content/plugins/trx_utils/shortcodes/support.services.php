...
if ( !function_exists( 'jardiwinery_services_detect_inheritance_key' ) ) {
	//Handler of add_filter('jardiwinery_filter_detect_inheritance_key',	'jardiwinery_services_detect_inheritance_key', 9, 1);
...
if ( !function_exists( 'jardiwinery_services_get_blog_type' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_blog_type',	'jardiwinery_services_get_blog_type', 9, 2);
...
if ( !function_exists( 'jardiwinery_services_get_blog_title' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_blog_title',	'jardiwinery_services_get_blog_title', 9, 2);
...
if ( !function_exists( 'jardiwinery_services_get_stream_page_title' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_stream_page_title',	'jardiwinery_services_get_stream_page_title', 9, 2);
...
if ( !function_exists( 'jardiwinery_services_get_stream_page_id' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_stream_page_id',	'jardiwinery_services_get_stream_page_id', 9, 2);
...
if ( !function_exists( 'jardiwinery_services_get_stream_page_link' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_stream_page_link',	'jardiwinery_services_get_stream_page_link', 9, 2);
...
if ( !function_exists( 'jardiwinery_services_get_current_taxonomy' ) ) {
	//Handler of add_filter('jardiwinery_filter_get_current_taxonomy',	'jardiwinery_services_get_current_taxonomy', 9, 2);
...
if ( !function_exists( 'jardiwinery_services_is_taxonomy' ) ) {
	//Handler of add_filter('jardiwinery_filter_is_taxonomy',	'jardiwinery_services_is_taxonomy', 9, 2);
...
if ( !function_exists( 'jardiwinery_services_query_add_filters' ) ) {
	//Handler of add_filter('jardiwinery_filter_query_add_filters',	'jardiwinery_services_query_add_filters', 9, 2);
...
if ( !function_exists( 'jardiwinery_sc_services' ) ) {
	...
	add_shortcode('trx_services', 'jardiwinery_sc_services');
}
...
if ( !function_exists( 'jardiwinery_sc_services_item' ) ) {
	...
	add_shortcode('trx_services_item', 'jardiwinery_sc_services_item');
}
// ---------------------------------- [/trx_services] ---------------------------------------
...
if (!function_exists('jardiwinery_services_reg_shortcodes')) {
	//Handler of add_filter('jardiwinery_action_shortcodes_list',	'jardiwinery_services_reg_shortcodes');
				...
				"trx_services" => array(
					...
					"params" => array(
						...
						"cat" => array(
							...
							"style" => "list",
							"multiple" => true,
							"options" => jardiwinery_array_merge(array(0 => esc_html__('- Select category -', 'trx_utils')), $services_groups)
						),
						"count" => array(
...
if (!function_exists('jardiwinery_services_reg_shortcodes_vc')) {
	//Handler of add_filter('jardiwinery_action_shortcodes_list_vc',	'jardiwinery_services_reg_shortcodes_vc');
		...
		vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        ...
                        "heading" => esc_html__("Service content", 'trx_utils'),
                        "description" => wp_kses_data( __("Select service content", 'trx_utils') ),
                        "class" => "",
                        "admin_label" => true,
                        "value" => array(
                            esc_html__('Full', 'trx_utils') => 'slyle_serv_full',
                            esc_html__('Minimal', 'trx_utils') => 'slyle_serv_minimal',
                            esc_html__('Full witn transparent background', 'trx_utils') => 'slyle_serv_transparent',
                        ),
                        "type" => "dropdown"
                    ),
					array(
					...
					array(
						...
						"class" => "",
						"value" => array_flip(jardiwinery_array_merge(array(0 => esc_html__('- Select category -', 'trx_utils')), $services_groups)),
						"type" => "dropdown"
					),
					array(
						"param_name" => "columns",
