...
if (!function_exists('jardiwinery_testimonial_add_override_options')) {
    //Handler of add_action('trx_utils_filter_override_options', 'jardiwinery_testimonial_add_override_options');
...
if (!function_exists('jardiwinery_testimonial_save_data')) {
	//Handler of add_action('save_post', 'jardiwinery_testimonial_save_data');
...
if (!function_exists('jardiwinery_sc_testimonials')) {
	...
	add_shortcode('trx_testimonials', 'jardiwinery_sc_testimonials');
}
...
if (!function_exists('jardiwinery_sc_testimonials_item')) {
	...
	add_shortcode('trx_testimonials_item', 'jardiwinery_sc_testimonials_item');
}
// ---------------------------------- [/trx_testimonials] ---------------------------------------
...
if (!function_exists('jardiwinery_testimonials_reg_shortcodes')) {
	//Handler of add_filter('jardiwinery_action_shortcodes_list',	'jardiwinery_testimonials_reg_shortcodes');
				...
				"trx_testimonials" => array(
					...
					"params" => array(
						...
						"cat" => array(
							...
							"style" => "list",
							"multiple" => true,
							"options" => jardiwinery_array_merge(array(0 => esc_html__('- Select category -', 'trx_utils')), $testimonials_groups)
						),
						"count" => array(
...
if (!function_exists('jardiwinery_testimonials_reg_shortcodes_vc')) {
	//Handler of add_filter('jardiwinery_action_shortcodes_list_vc',	'jardiwinery_testimonials_reg_shortcodes_vc');
		...
		vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        ...
                        "class" => "",
                        "value" => array(
                            esc_html__('Original', 'trx_utils') => 'testimonials_original',
                            esc_html__('Transparent', 'trx_utils') => 'testimonials_transparent',
                            esc_html__('For product (transparent background)', 'trx_utils') => 'testimonials_product',
                        ),
                        "type" => "dropdown"
                    ),
					array(
					...
					array(
						...
						"class" => "",
						"value" => array_flip(jardiwinery_array_merge(array(0 => esc_html__('- Select category -', 'trx_utils')), $testimonials_groups)),
						"type" => "dropdown"
					),
					array(
						"param_name" => "columns",
