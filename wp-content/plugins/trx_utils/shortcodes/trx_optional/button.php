...
if (!function_exists('jardiwinery_sc_button')) {	
	...
	add_shortcode('trx_button', 'jardiwinery_sc_button');
}
		...
		jardiwinery_sc_map("trx_button", array(
			...
			"params" => array(
				...
				"icon" => array(
					...
					"desc" => wp_kses_data( __('Select icon for the title from Fontello icons set (not for small filled or bordered button)',  'trx_utils') ),
					"value" => "",
					"type" => "icons",
			...
			"params" => array(
				...
				array(
					...
					"value" => array(
                        ...
                        esc_html__('Only icon', 'trx_utils') => 'icon'
					),
					"type" => "dropdown"
				),
                array(
                    ...
                    "value" => array(
                        esc_html__('Original', 'trx_utils') => 'original',
                        esc_html__('Light', 'trx_utils') => 'light'
                    ),
                    "type" => "dropdown"
                ),
				array(
					...
					"value" => array(
						...
						esc_html__('Medium (use only for button with icon)', 'trx_utils') => 'medium',
