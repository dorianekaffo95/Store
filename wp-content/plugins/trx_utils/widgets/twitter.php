...
class jardiwinery_widget_twitter extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'jardiwinery_widget_twitter', esc_html__('JardiWinery - Twitter', 'trx_utils'), $widget_ops );
	}
...
if ( !function_exists( 'jardiwinery_sc_widget_twitter' ) ) {
	...
	add_shortcode("trx_widget_twitter", "jardiwinery_sc_widget_twitter");
}
