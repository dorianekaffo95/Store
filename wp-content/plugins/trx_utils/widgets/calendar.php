...
class jardiwinery_widget_calendar extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'jardiwinery_widget_calendar', esc_html__('JardiWinery - Advanced Calendar', 'trx_utils'), $widget_ops );
	}
...
if ( !function_exists( 'jardiwinery_sc_widget_calendar' ) ) {
	...
	add_shortcode("trx_widget_calendar", "jardiwinery_sc_widget_calendar");
}
