...
class jardiwinery_widget_categories extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'jardiwinery_widget_subcategories', esc_html__('JardiWinery - Subcategories list', 'trx_utils'), $widget_ops );
	}
...
if ( !function_exists( 'jardiwinery_sc_widget_categories' ) ) {
	...
	add_shortcode("trx_widget_categories", "jardiwinery_sc_widget_categories");
}
		...
		vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"class" => "",
						"value" => array_flip(jardiwinery_array_merge(array(0 => esc_html__('- Select category -', 'trx_utils')), $categories)),
						"type" => "dropdown"
					),
