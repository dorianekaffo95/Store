...
class jardiwinery_widget_banner extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'jardiwinery_widget_banner', esc_html__('JardiWinery - Banner', 'trx_utils'), $widget_ops );
	}
...
if ( !function_exists( 'jardiwinery_sc_widget_banner' ) ) {
	...
	add_shortcode("trx_widget_banner", "jardiwinery_sc_widget_banner");
}
