...
class jardiwinery_widget_socials extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'jardiwinery_widget_socials', esc_html__('JardiWinery - Show logo and social links', 'trx_utils'), $widget_ops );
	}
...
if ( !function_exists( 'jardiwinery_sc_widget_socials' ) ) {
	...
	add_shortcode("trx_widget_socials", "jardiwinery_sc_widget_socials");
}
