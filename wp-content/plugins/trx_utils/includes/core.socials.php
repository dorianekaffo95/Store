...
-------------------------------------------------------------------------------- */
if (!function_exists('jardiwinery_socials_theme_setup1')) {
    add_action('jardiwinery_action_before_init_theme', 'jardiwinery_socials_theme_setup1');
    function jardiwinery_socials_theme_setup1()
    {
