...
if (!function_exists('jardiwinery_add_fields_in_user_info')) {
    function jardiwinery_add_fields_in_user_info( $user ) {
        ?>
                    ...
                    if (!empty($sn)) {
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="user_<?php echo esc_attr($sn); ?>" id="user_<?php echo esc_attr($sn); ?>" size="55" value="<?php echo esc_attr(get_the_author_meta('user_'.($sn), $user->ID)); ?>" />
                                <span class="description"><?php echo sprintf(esc_html__('Please, enter your %s link', 'trx_utils'), jardiwinery_strtoproper($sn)); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
...
if (!function_exists('jardiwinery_save_fields_in_user_info')) {
    function jardiwinery_save_fields_in_user_info( $user_id ) {
...
if(!function_exists('trx_utils_filter_options')){
    add_filter('jardiwinery_filter_options', 'trx_utils_filter_options');
...
if (function_exists('jardiwinery_get_custom_option')){
    if ( jardiwinery_get_custom_option('show_googlemap')=='yes' ) {
        ...
        wp_enqueue_script( 'jardiwinery-googlemap-script', trx_utils_get_file_url('js/core.googlemap.js'), array(), null, true );
    }
}
